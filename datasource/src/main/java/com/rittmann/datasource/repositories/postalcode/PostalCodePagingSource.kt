...
import com.rittmann.datasource.local.dao.selectAll
...
class PostalCodePagingSource @Inject constructor(
...
) : PagingSource<Int, com.rittmann.datasource.model.PostalCode>() {
    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, com.rittmann.datasource.model.PostalCode> {
    ...
    override fun getRefreshKey(state: PagingState<Int, com.rittmann.datasource.model.PostalCode>): Int? {
