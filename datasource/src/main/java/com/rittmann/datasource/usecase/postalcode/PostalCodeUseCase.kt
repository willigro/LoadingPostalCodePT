...
class PostalCodeUseCaseImpl @Inject constructor(
    ...
    override fun pagingSource(query: String): LiveData<PagingData<com.rittmann.datasource.model.PostalCode>> {
...
//        )
    ...
    private fun getPeriodicId(uuid: UUID, workerType: WorkerType, isRunning: Boolean): UUID {
        Log.i("TESTING", "PostalCodeUseCaseImpl getPeriodicId uuid=$uuid, workerType=$workerType, isRunning=$isRunning")
